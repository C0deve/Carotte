...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CarotteTestAssertionException"/> class with a specified error message.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CarotteTestAssertionException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
    /// </summary>
    /// <param name="message">The message that describes the assertion failure.</param>
