...
public static class CarotteDiagnostics
{
    ...
    public static readonly Counter<long> MessagesPublishedCounter = Meter.CreateCounter<long>("carotte_messages_published", description: "Number of messages published");
